...
HD_PWD='/home/rishab/Documents/ECE_385_Final_Project/DoodleJump/DoodleJump.runs/mb_block_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_block_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_block_xbar_0.tcl
