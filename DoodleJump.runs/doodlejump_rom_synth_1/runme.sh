...
HD_PWD='/home/rishab/Documents/ECE_385_Final_Project/DoodleJump/DoodleJump.runs/doodlejump_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log doodlejump_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source doodlejump_rom.tcl
