...
HD_PWD='/home/rishab/Documents/lab6/lab6.runs/mb_block_axi_gpio_2_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_block_axi_gpio_2_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_block_axi_gpio_2_1.tcl
