...
HD_PWD='/home/rishab/Documents/ECE_385_Final_Project/DoodleJump/DoodleJump.runs/gameover_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gameover_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gameover_rom.tcl
