...
rt::set_parameter fanoutOpt2SkipCarryInDriver {true}
...
rt::set_parameter supportConstantBSelOutOfBound {true}
...
rt::set_parameter retBoundArea {100000}
rt::set_parameter retBoundedOneLevelSlack {8000}
rt::set_parameter retBoundedSlack {2600}
rt::set_parameter retBwrdCtrlPinDelay {200}
rt::set_parameter retBwrdIgnoreInitDebug {true}
...
rt::set_parameter retFwrdCritLimit {300}
rt::set_parameter retFwrdCtrlPinDelay {50}
rt::set_parameter retFwrdMinGain {20}
rt::set_parameter retIoReg {1}
rt::set_parameter retLevelDelay {100}
...
# Group: HARTMLNlOptPrediction
rt::set_parameter nlOptSmartMLPredictionProbabilityThreshold {60}
# Group: HARTNNetDelayReader
rt::set_parameter delayReaderDbg {0}
rt::set_parameter useGetCellNameMapping_cached {true}
...
# Group: HARTPACellDelayVeam
rt::set_parameter versalCLK2CE {-140}
rt::set_parameter versalCLK2Q {120}
rt::set_parameter versalCLK2RS {100}
rt::set_parameter versalControlArc {11}
# Group: HARTPrepRetiming
rt::set_parameter backwardWNSRatio {20}
rt::set_parameter fixCarry2Group {true}
rt::set_parameter forwardWNSRatio {20}
rt::set_parameter retFwrdFanout {20}
rt::set_parameter retMoreURAMReg {true}
...
rt::set_parameter retimingFwrdCtrlFanout {-1}
rt::set_parameter worstSlackRatio {20}
# Group: HARTResynthHandleRtd
rt::set_parameter dumpPreservedModulesRtdsInTmpDir {false}
rt::set_parameter handleResynthRtdDebug {2}
rt::set_parameter rubikReuseGlobalNames {true}
...
rt::set_parameter resynthMgrDebug {2}
rt::set_parameter resynthMgrDebugMsg {false}
rt::set_parameter rubikEnableExtRamReg {false}
rt::set_parameter rubikEnableRamPipeline {false}
# Group: HARTRet
rt::set_parameter synNewIterations {1}
# Group: HARTRetUtil
rt::set_parameter retimingPattern {0}
# Group: HARTRetime
...
# Group: HARTRetiming
rt::set_parameter BwrdCarry2Slack {0}
rt::set_parameter blockLeveRetimingThreshold {-1}
rt::set_parameter enableOptIOFlops {false}
rt::set_parameter retAdustCarryInReg {true}
rt::set_parameter retAsyncReg {true}
rt::set_parameter retAutoPipeline {false}
rt::set_parameter retBlockDelay {true}
rt::set_parameter retBlockNetDelay {350}
rt::set_parameter retBwrdFanout {100}
rt::set_parameter retBwrdIgnoreInitCondition {false}
rt::set_parameter retBwrdLocalDelta {1200}
rt::set_parameter retBwrdWorstDelta {700}
rt::set_parameter retBwrdWorstDelta2 {500}
...
rt::set_parameter retCpuTime {false}
rt::set_parameter retCritEdges {false}
rt::set_parameter retCritLevel {2}
rt::set_parameter retCtlTimingArc {true}
rt::set_parameter retCtrlDelta {800}
rt::set_parameter retCtrlFanoutLimit {8}
rt::set_parameter retCtrlPin {false}
...
rt::set_parameter retDriverFanout {4}
...
rt::set_parameter retForURAM {true}
rt::set_parameter retForceTopOutReg {true}
rt::set_parameter retFwrdLocalDelta {1000}
rt::set_parameter retFwrdMinDelta {30}
rt::set_parameter retFwrdWorstDelta {700}
rt::set_parameter retFwrdWorstDelta2 {500}
rt::set_parameter retGatedClock {false}
rt::set_parameter retIgnoreCtrlGateDelay {false}
rt::set_parameter retImprove {1}
rt::set_parameter retImproveRunTime {true}
...
rt::set_parameter retRAM36E5ClkToOut {1050}
rt::set_parameter retRAM36E5Setup {1050}
rt::set_parameter retRemapLut {false}
rt::set_parameter retSeqSize {2000}
rt::set_parameter retSetDelta {150}
rt::set_parameter retSetPin {false}
rt::set_parameter retSlackBound {150}
rt::set_parameter retSlackBound2 {150}
rt::set_parameter retSlackDelta {525}
rt::set_parameter retSlackEffort {20}
...
rt::set_parameter retVersalCarry {false}
rt::set_parameter retVersalRAM {true}
rt::set_parameter retWorstSlackBound {20000}
rt::set_parameter retWorstSlackDelta {500}
rt::set_parameter retWriteGraph {false}
rt::set_parameter retimingIOFlops {false}
rt::set_parameter retimingLOOKAHEAD8 {true}
rt::set_parameter retimingSlackDebug {0}
rt::set_parameter retimingSlackLevel {1}
...
# Group: HARTTNetDelay
rt::set_parameter adjustGenomeDelay {1}
...
rt::set_parameter multiLoadDelay {470}
...
rt::set_parameter reportModule {0}
...
rt::set_parameter optimizeReinfer {false}
...
# Group: hartcleanup
rt::set_parameter absorbDataInverter {false}
...
rt::set_parameter collapseLutsPostInsertIO {true}
rt::set_parameter collapseLutsTiming {true}
rt::set_parameter collapseLutsVerbose {false}
rt::set_parameter collectOutMuxcyVersal {false}
...
rt::set_parameter dontTouchOnInsertedAnchor {true}
...
rt::set_parameter packLoadLutsOfCarryToCarryChain {false}
...
rt::set_parameter retimeCtrlForSrl {true}
...
rt::set_parameter searchImmediateRegLoadLevel {3}
...
rt::set_parameter retimingPrepOnly {false}
# Group: hartgdp
rt::set_parameter compareZeroShortCut {true}
rt::set_parameter datapathAddDisjointTimingThreshold {35}
rt::set_parameter datapathComparatorConstOpt {false}
rt::set_parameter datapathComparatorConstThreshold {30}
rt::set_parameter datapathEqMaxBitsPerStage {-1}
rt::set_parameter datapathLGTDisjointTimingThreshold {16}
...
rt::set_parameter removeConstInEqGen {0}
rt::set_parameter timingDrivenGeneratorEq {false}
rt::set_parameter useOriginalCSA {false}
rt::set_parameter useXilinxBoothMultiplier {false}
rt::set_parameter xilinxBoothAvoidMSBCarryMapping {false}
rt::set_parameter xilinxBoothSignedMaxThreshold {12}
rt::set_parameter xilinxBoothSignedMinThreshold {4}
rt::set_parameter xilinxBoothUnsignedMaxThreshold {13}
rt::set_parameter xilinxBoothUnsignedMinThreshold {5}
# Group: hartgsrlgen
rt::set_parameter disableTimingCheckInSRLGeneration {true}
rt::set_parameter retimingSRLEndMaxLength {30}
rt::set_parameter retimingSRLEndMinLength {4}
rt::set_parameter retimingSRLStartMinLength {4}
...
rt::set_parameter enableIddrInfer {false}
rt::set_parameter enableOddrInfer {false}
...
# Group: hartlutmap
rt::set_parameter cr1125725 {false}
rt::set_parameter lutMapFreezeTimer {true}
rt::set_parameter restoreLut6cyForConstSPG {true}
rt::set_parameter tdMapperEndCompFactor1 {-1000}
rt::set_parameter tdMapperEndCompFactor2 {300}
rt::set_parameter tdMapperLevelFactor {1600}
rt::set_parameter tdMapperNewReqCompFactor {2}
rt::set_parameter tdMapperScaleFactor1 {2}
rt::set_parameter tdMapperScaleFactor2 {1}
rt::set_parameter tdMapperStartDelayFactor1 {14000}
rt::set_parameter tdMapperStartDelayFactor2 {4000}
rt::set_parameter tdMapperStartDelayFactor3 {12000}
rt::set_parameter timingDrivenSetArrivalOnBoundary {true}
# Group: hartndb
rt::set_parameter block_nlopt {false}
...
rt::set_parameter fixIPRetiming {false}
rt::set_parameter fixTimingConstraints {false}
rt::set_parameter generateCnfForTopGraph {false}
rt::set_parameter inferMultiRatio {0.700000}
rt::set_parameter lutPairNewThreshold {true}
rt::set_parameter lutPairNewThreshold2 {false}
rt::set_parameter markGenomePinsConnectedToTopModule {true}
rt::set_parameter optimizeReinfer2 {0}
rt::set_parameter optimizeReinfer2Debug {false}
rt::set_parameter preserveGenomesInsideSBlocks {false}
rt::set_parameter print_nlopt_checksum {false}
...
# Group: hartnlmacrocluster
rt::set_parameter addSoftMacroCoordinate {false}
rt::set_parameter clusterURAM {true}
rt::set_parameter macroClusterLevel0 {false}
rt::set_parameter macroClusterLevel1 {true}
# Group: hartnloptFX
rt::set_parameter nlOptCSEWeight {0}
# Group: hartnloptframework
rt::set_parameter nlOptAggrBdd {0}
rt::set_parameter nlOptAig {0}
rt::set_parameter nlOptAreaSpeed {0}
rt::set_parameter nlOptAsis {none-0}
rt::set_parameter nlOptAutoCSS {0-7-2}
rt::set_parameter nlOptBDDOrdering {0}
rt::set_parameter nlOptCommon {0}
rt::set_parameter nlOptComplBdd {0}
rt::set_parameter nlOptCritcalSignal {}
rt::set_parameter nlOptDebugCheckSum {0}
rt::set_parameter nlOptDisplayandSimulate {0}
rt::set_parameter nlOptDumpDataFromThisRunML {0}
rt::set_parameter nlOptExpt {0}
rt::set_parameter nlOptFastFlow {0}
rt::set_parameter nlOptForwardCollapse {1}
rt::set_parameter nlOptGatedClockVerbose {0}
rt::set_parameter nlOptInPlaceReplace {1}
...
rt::set_parameter nlOptPrintNumAlg {0}
rt::set_parameter nlOptRedRemoval {0}
rt::set_parameter nlOptReduceDepth {1}
rt::set_parameter nlOptRewrite {1-1-4-8-10-100000}
rt::set_parameter nlOptRewriteMode {1}
rt::set_parameter nlOptRewriteNumConeOptimized {0}
rt::set_parameter nlOptRunRewrite {0}
rt::set_parameter nlOptRunRewriteInStandAlone {1}
rt::set_parameter nlOptRunRewriteNumRun {3}
rt::set_parameter nlOptSimulateBeforeInsert {7}
rt::set_parameter nlOptSingleOutputMinimization {0}
rt::set_parameter nlOptTinyDesign {0}
rt::set_parameter nlOptUseCache {1}
rt::set_parameter nlOptUseCacheML {1}
rt::set_parameter nlOptUseReadFileML {0}
rt::set_parameter nlOptUseSeparateBdd {0}
rt::set_parameter nlOptUseSeparateBddForStandalone {0}
rt::set_parameter nlOptUseSmartML {2}
...
# Group: hartoptimizeLookAhead
rt::set_parameter debugOptimizeLookAhead {1}
...
rt::set_parameter PartId {xc7s50csga324-1}
...
rt::set_parameter breakupMacroClustersNetlist {true}
...
rt::set_parameter carryLUTSizeThreshold {6}
...
rt::set_parameter combineLutsForUserInst {false}
...
rt::set_parameter constPropLookahead8 {true}
...
rt::set_parameter crossClockDomainRetiming {true}
rt::set_parameter cutCostModifierForFirstMapbuf3_1 {false}
rt::set_parameter cutSelectStyle {0}
...
rt::set_parameter debugDspTernaryInfer {0}
...
rt::set_parameter depthFirstMapbuf31Mapping {false}
rt::set_parameter depthFirstMapbuf31MappingFix {true}
...
rt::set_parameter doExtAsymBramAreaOpt {true}
...
rt::set_parameter enableContrlConversion {true}
...
rt::set_parameter enableIterativeIncrementalSynthesis {true}
...
rt::set_parameter fanoutAsyncRetiming {true}
...
rt::set_parameter helper_shm_key {LaunchHelperProcessKey_137355_1714416337}
...
rt::set_parameter honorRamStyleInResourceBalancing {true}
...
rt::set_parameter inferAsymBramForMinArea {true}
rt::set_parameter inferAsymURam {true}
rt::set_parameter inferBDPreAdder {true}
...
rt::set_parameter inferBramWithParity {true}
...
rt::set_parameter inferDspDynamicMultNegate {true}
...
rt::set_parameter inferMultiPortRam {true}
...
rt::set_parameter inferOutputCascadeForDspComplex {true}
rt::set_parameter inferOutputCascadeFromPtoCPath {true}
...
rt::set_parameter macroClusterIncludeMultiType {true}
rt::set_parameter macroClusterSizeLimit {50}
...
rt::set_parameter maxRamAddrSize {32}
...
rt::set_parameter mergeLutRam {6}
rt::set_parameter mergeMuxesWriteFirstRam {false}
rt::set_parameter mergeTernaryAdderInSingleDsp {true}
...
rt::set_parameter minimizeCounterWidth {true}
...
rt::set_parameter muxpartDebug {0}
...
rt::set_parameter nlOptMaxSolnsUsingSmartML {2}
rt::set_parameter nlOptMuxpart {false}
rt::set_parameter nlOptRom {1}
rt::set_parameter nlOptSmartMLSupportedDevice {10}
rt::set_parameter nloptSmartMLPredictionDebug {0}
rt::set_parameter noPenaltyForMAPBUF3_1 {false}
...
rt::set_parameter packOpAtDataOutForMultiFanout {false}
...
rt::set_parameter preserveRAMPartition {false}
rt::set_parameter preserveSelectedDp {false}
...
rt::set_parameter ramSynVerbose {0}
...
rt::set_parameter regenerateAsymRam {true}
...
rt::set_parameter reportDspFinal {true}
rt::set_parameter reportDspNetlistDrc {true}
rt::set_parameter reportDspPreliminary {true}
...
rt::set_parameter rubikInMemoryFlow {false}
rt::set_parameter rubikPipelinedCE {false}
rt::set_parameter rubikTest {false}
...
rt::set_parameter slackThreshTDRamGen {50000}
...
rt::set_parameter speedupTechmapForNonTimingDrivenFlow {false}
...
rt::set_parameter synRetimingPattern {0}
...
rt::set_parameter useHARTLutMap2 {false}
...
rt::set_parameter versalAsyncRegInDsp {true}
...
rt::set_parameter writeWildcardsInMetricDBForRetimeAcrossOperatorsSuggestion {false}
...
rt::set_parameter xilinxNewSDPRam {6}
...
rt::set_parameter skipLoadingArcsForDCMAC {true}
rt::set_parameter skipLoadingArcsForPS9 {true}
# Group: hdl
...
rt::set_parameter diffPortNetNames {false}
...
rt::set_parameter skipDfgOpt {true}
...
# Group: hoptCluster
rt::set_parameter breakClusterInDfg {false}
rt::set_parameter calculateLCAForNonMacros {true}
rt::set_parameter clusterDebug {false}
rt::set_parameter hoptClusterEdgeWeightLimit {20}
rt::set_parameter maxClusterInsts {50}
rt::set_parameter minClusterSize {true}
rt::set_parameter skipNonMacros {false}
# Group: hoptDataflow
rt::set_parameter DFVdontDissolveEmptyGraphs {false}
rt::set_parameter busViewFixBrokenConnections {false}
rt::set_parameter calculateGraphEdgeWeight {true}
rt::set_parameter createDFGBusGraph {true}
rt::set_parameter edgeBasedBusHighlighting {true}
rt::set_parameter ignoreConstPrimInputs {false}
rt::set_parameter ignoreConstPrimNode {true}
rt::set_parameter minPossibleBusWidth {2}
...
# Group: lint
rt::set_parameter blockUnisimWarnings {true}
rt::set_parameter checkAdderMerge {true}
rt::set_parameter checkArithOverflow {true}
rt::set_parameter checkCaseEquality {true}
rt::set_parameter checkComparatorMismatch {true}
rt::set_parameter checkDualEdgeModule {true}
rt::set_parameter checkFullCase {true}
rt::set_parameter checkLatchInfer {true}
rt::set_parameter checkMissingAsyncReset {true}
rt::set_parameter checkMultiAssign {true}
rt::set_parameter checkMultiResetsBlock {true}
rt::set_parameter checkShiftOverflow {true}
rt::set_parameter checkSignednessResolution {true}
rt::set_parameter checkUnreadArrayBits {true}
rt::set_parameter checkUnreadSignal {true}
rt::set_parameter checkUnsetArrayBits {true}
rt::set_parameter lintBitsAssignScalar {true}
rt::set_parameter lintDbg {0}
rt::set_parameter lintEncryptedModule {false}
rt::set_parameter lintXilinxIP {false}
rt::set_parameter lint_ASSIGN1_precisionDelta {2}
rt::set_parameter lint_ASSIGN1_reducedPattern {false}
rt::set_parameter lint_ASSIGN2_reducedPattern {true}
rt::set_parameter lint_ASSIGN7_allowBMergeFanout {false}
rt::set_parameter lint_ASSIGN_maskTristateBufferMultiAssign {true}
rt::set_parameter lint_ASSIGN_reportBitWidthMismatch {true}
rt::set_parameter lint_ASSIGN_useLintBitsAssignInArrayNew {true}
rt::set_parameter lint_ASSIGN_variableInAlwaysBlock {false}
rt::set_parameter lint_MsgSortByFile {true}
# Group: loptabcverify
...
rt::set_parameter elabVhdlFormalFunctionCall {true}
...
rt::set_parameter enableVhdlUseDSPFP32 {false}
...
rt::set_parameter printDefaultValueParams {false}
rt::set_parameter printIPSubParams {false}
...
rt::set_parameter svMarkModDivNodes {true}
...
rt::set_parameter vhdlMarkModRemNodes {true}
...
rt::set_parameter vhdlSupportToStringFunction {true}
rt::set_parameter vhdlUnconstRecordAggr {true}
rt::set_parameter vhdlUseDSPFP32 {false}
...
rt::set_parameter skipRemoveRedundantMuxSelForSmallAndWideMux {false}
...
rt::set_parameter parallelConstprop {0}
...
rt::set_parameter skipTimingOptimization {false}
...
# Group: optimizeOpt
rt::set_parameter optimizeSelPrePlace {101}
# Group: pcr
...
rt::set_parameter computeAPRangeForVariableMuxNodes {false}
...
rt::set_parameter optimizeFSMMuxUsingRangeSet {false}
rt::set_parameter optimizeMuxUsingRangeset {true}
...
rt::set_parameter propagateRangeThroughRegNodes {false}
...
rt::set_parameter recomputeAPRangeSetForRegNodes {false}
rt::set_parameter recomputeRangeForRegWithFeedback {false}
...
rt::set_parameter addPathInMacroDotCluster {false}
...
rt::set_parameter allowPotentialFsmMuxControlCollapse {false}
...
rt::set_parameter assignsForBusNetlist {0}
...
rt::set_parameter avoidSplitPartitionForBitNodesWithDonotCare {true}
...
rt::set_parameter checkLicenseHoldSupport {true}
rt::set_parameter checkLogicDepthAtMuxSelect {within_module}
rt::set_parameter checkMuxInOutsForEquivalency {true}
...
rt::set_parameter connectConstantPinsForNetlist {true}
...
rt::set_parameter constructSizeLimitForDfgVerilog {10000}
rt::set_parameter constructStgInGenerator {true}
rt::set_parameter contiguousRangeThresholdToEnableReduceBigSharedMux {10}
rt::set_parameter controlSetSwitch {false}
rt::set_parameter convertConstructInputsToRanges {true}
rt::set_parameter convertMux2WireWithSameAsDefault {false}
...
rt::set_parameter createDfgPartConstrRecurLimit {1}
...
rt::set_parameter crossBoundaryOpt {true}
...
rt::set_parameter dataflowGraphClustering {false}
rt::set_parameter dataflowGraphPass2Clustering {false}
rt::set_parameter dataflowHierBusHighlighting {true}
...
rt::set_parameter dataflowPruneDeadMuxes {true}
rt::set_parameter dataflowPruneNonWideBussedAdders {true}
...
rt::set_parameter disableOneHotFsmMuxCollapse {true}
...
rt::set_parameter disableTDMapOnTException {true}
...
rt::set_parameter doRangeBasedModNodeOptimization {true}
...
rt::set_parameter dumpGenomesToEnableIncremental {false}
...
rt::set_parameter eliminateConstRegWithMultLoad {false}
...
rt::set_parameter eliminateRelativeConstantReg {false}
rt::set_parameter enableAsymRamAsyncReset {true}
rt::set_parameter enableBwweDatapathOpt {true}
...
rt::set_parameter enableSplitFlowPath {./.Xil/Vivado-137355-michael-XPS-13-9360/}
rt::set_parameter enableSplitFlowStep {0}
...
rt::set_parameter inferPatternDetectForSub {true}
...
rt::set_parameter keepBselWithpartialNegIndexInPartition {true}
...
rt::set_parameter maxInputIncreaseToMerge {1000}
...
rt::set_parameter minModuleWireCount {1000}
rt::set_parameter minNoOfPinsForMuxReductWithSameAsDefault {1000}
rt::set_parameter minReductRatioForMuxReductWithSameAsDefault {75}
...
rt::set_parameter muxesWithDataEqualsSelect {true}
...
rt::set_parameter noSynRetimingSwitch {false}
...
rt::set_parameter numberOfPinsToEnableReduceBigSharedDataMux {12288}
...
rt::set_parameter optimizeDFGTopDownTraversal {true}
...
rt::set_parameter parallelDFGDumpMode {false}
rt::set_parameter parallelDFGOptMinSize {5000}
rt::set_parameter parallelDFGOptPass1 {true}
...
rt::set_parameter preScanHierMismatch {false}
...
rt::set_parameter propagateRangeSetThroughRegNodes {false}
...
rt::set_parameter pruneNodeIfBitSelLoadOnly {true}
...
rt::set_parameter ramFromADTThreshold {8192}
...
rt::set_parameter reduceBigSharedDataMuxToCascadeOfSmallMuxes {false}
rt::set_parameter reduceMuxHavingSameValueAsDefault {true}
rt::set_parameter reduceToplevelInverters {false}
rt::set_parameter reduceVariableBitSelect {true}
rt::set_parameter reducedRatioToEnableReduceBigSharedMux {0.750000}
...
rt::set_parameter removeRedundantBconcBselTreePattern {true}
...
rt::set_parameter removeVModDuringDissolveSmallPartitions {false}
...
rt::set_parameter retimingMultiplier {true}
rt::set_parameter retimingOptLevel {1}
...
rt::set_parameter rubikFlow {false}
...
rt::set_parameter simplifyBmergeDrivenByBconcs {true}
...
rt::set_parameter simplifyFlattenUnflattenVector {false}
...
rt::set_parameter strictWireRemoval {true}
...
rt::set_parameter synFlattenHierarchyValue {2}
...
rt::set_parameter synRetimingSwitch {false}
...
rt::set_parameter xilinxConnectUndrivenWireWithInit {false}
...
rt::set_parameter adjustBufNetDelay {false}
rt::set_parameter adjustGenomeInputNetDelay {false}
...
rt::set_parameter bufNetDelay {200}
...
rt::set_parameter fixGeneratedClock {3}
rt::set_parameter forceNewGenomeTiming {false}
...
rt::set_parameter ignoreSlew {false}
...
rt::set_parameter noRecalculateInvalidSlack {false}
...
rt::set_parameter scaleGenomeDelay {100}
