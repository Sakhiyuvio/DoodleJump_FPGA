...
HD_PWD='/home/rishab/Documents/ECE_385_Final_Project/DoodleJump/DoodleJump.runs/doodle_up_t_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log doodle_up_t_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source doodle_up_t_rom.tcl
