...
HD_PWD='/home/rishab/Documents/lab6/lab6.runs/mb_block_clk_wiz_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_block_clk_wiz_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_block_clk_wiz_1_0.tcl
