...
module mb_intro_top
  ...
  mb_block mb_block_i
       (.clk_100MHz(clk),
        .gpio_rtl_0_tri_o(led), // this is to show the led values 
        .gpio_rtl_1_tri_i(sw), // this is to get data from the switches 
        .gpio_rtl_2_tri_i({btn[1], btn[0]}), // this is for accumulate button input 
